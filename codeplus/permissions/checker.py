...
from codeplus.permissions.dangerous import DangerousCommandDetector, is_safe_command
from codeplus.permissions.modes import DecisionEffect, PermissionMode, mode_decide
from codeplus.permissions.rules import Rule, RuleEngine, evaluate_rules, extract_content
from codeplus.permissions.sandbox import PathSandbox
from codeplus.tools.base import Tool
...
class PermissionChecker:
    ...
    def _is_plan_file(self, target_path: str) -> bool:
        if not self.plan_file_path or not target_path:
            return ".codeplus/plans/" in target_path
        try:
