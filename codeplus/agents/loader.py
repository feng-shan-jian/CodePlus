...
PROJECT_AGENTS_DIR = ".codeplus/agents"
USER_AGENTS_DIR = "~/.codeplus/agents"
...
class AgentLoader:
    ...
    def _load_builtins(self) -> list[AgentDef]:
        results: list[AgentDef] = []
        try:
            builtins_pkg = importlib.resources.files("codeplus.agents.builtins")
        ...
        for item in builtins_pkg.iterdir():
            ...
            try:
                ...
                from codeplus.agents.parser import parse_frontmatter, _validate_agent_meta
