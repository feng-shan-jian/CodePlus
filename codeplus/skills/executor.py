...
from codeplus.skills.parser import SkillDef, substitute_arguments

if TYPE_CHECKING:
    from codeplus.agent import Agent, AgentEvent
...
class SkillExecutor:
    ...
    async def execute_fork(
        ...
        from codeplus.agent import Agent as AgentClass, StreamText, LoopComplete, ErrorEvent
