...
from codeplus.teams.backend_detect import BackendDetectionError, detect_backend
from codeplus.teams.mailbox import Mailbox, create_message
...
from codeplus.teams.progress import TeammateProgress
from codeplus.teams.registry import AgentNameRegistry
from codeplus.teams.shared_task import SharedTaskStore
from codeplus.teams.spawn_inprocess import InProcessTeammateHandle
    ...
    def _kill_pane(self, pane_id: str, backend_type: str) -> None:
        try:
            if backend_type == BackendType.TMUX.value:
                from codeplus.teams.spawn_tmux import kill_pane
                kill_pane(pane_id)
            elif backend_type == BackendType.ITERM2.value:
                from codeplus.teams.spawn_iterm2 import kill_pane
                kill_pane(pane_id)
