...
from codeplus.memory.auto_memory import ENTRYPOINT_NAME, MAX_ENTRYPOINT_LINES
...
class MemoryConsolidator:
    ...
    def __init__(
        ...
        *,
        ...
        self._mem_dir = os.path.join(work_dir, ".codeplus", "memory")
        self._user_mem_dir = os.path.join(Path.home(), ".codeplus", "memory")
    ...
    async def _do_consolidation(
        ...
        transcript_dir = os.path.join(self._work_dir, ".codeplus", "sessions")
        ...
        checker = PermissionChecker(
            ...
            rule_engine=RuleEngine(
                ...
                project_rules_path=Path(self._work_dir) / ".codeplus" / "permissions.yaml",
                local_rules_path=Path(self._work_dir) / ".codeplus" / "permissions.local.yaml",
            ),
